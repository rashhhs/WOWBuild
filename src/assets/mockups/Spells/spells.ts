...
import * as frostStrike from 'src/assets/mockups/Spells/frost-strike.json'
import * as frostscythe from 'src/assets/mockups/Spells/frostscythe.json'
import * as frostwyrmFury from 'src/assets/mockups/Spells/frostwyrms-fury.json'
import * as gatheringStorm from 'src/assets/mockups/Spells/gathering-storm.json'
import * as howlingBlast from 'src/assets/mockups/Spells/howling-blast.json'
import * as hypothermicPresence from 'src/assets/mockups/Spells/hypothermic-pressence.json'
